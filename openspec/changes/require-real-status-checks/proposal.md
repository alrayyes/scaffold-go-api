...
pull-request-triggered check names: `api`, `build`, `check`, `commits`,
`docker`, `dockerfile`, `gomod`, `lint`, `mechanics`, `prose`, `secrets`,
`style`, `test` Names came from an actual pull request, not guessed from
workflow job keys.
